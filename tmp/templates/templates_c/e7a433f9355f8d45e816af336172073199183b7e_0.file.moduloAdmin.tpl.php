<?php
/* Smarty version 4.1.1, created on 2022-05-28 04:35:52
  from 'C:\xampp\htdocs\testSofttek\app\templates\modulo\moduloAdmin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_62918a88c9c898_94047477',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e7a433f9355f8d45e816af336172073199183b7e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\testSofttek\\app\\templates\\modulo\\moduloAdmin.tpl',
      1 => 1653705340,
      2 => 'file',
    ),
  ),
...
function content_62918a88c9c898_94047477 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="es">
...
" /> Softtek
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    <li class="mr-3">
                        <a class="inline-block py-2 px-4 text-black no-underline" id="crudUsuarios" href="moduloCrud.php">Gestión de usuarios</a>
                    </li>
                </ul>

                <a href="../">
                    <button  id="cerrarSesion" class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                        Cerrar sesión
                    </button>
                </a>
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                <p class="leading-normal text-2xl mb-8">
                    Bienvenido al panel de adminsitradores.
                </p>
            </div>
            <!--Derecha Col-->
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
                ¡Hola <?php echo $_smarty_tpl->tpl_vars['nombreApellido']->value;?>
!
            </h1>
            ...
            <div class="w-full p-6 mt-6">
                <div class="align-middle">
                    <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3 text-center">
                        Tu rol: <span class="text-blue">administrador</span>
                    </h3>
                    <p class="text-gray-600 mb-8 text-center">
                        Este panel es exclusivo para administrador, ¿Que te parece?
                    <br />
                    </p>
                </div>
            </div>
